...
$sqlarray = $dict->CreateTableSQL(cms_db_prefix() . "module_xmlmadesimple_feed", $flds, $taboptarray);
$dict->ExecuteSQLArray($sqlarray);

// create a sequence
$db->CreateSequence(cms_db_prefix() . "module_xmlmadesimple_feed_seq");
...
// permissions
$this->CreatePermission('Manage XML Made Simple', 'Manage XML Made Simple');
...
// set this when only 1.11+ is supported
